		...
		>
			...
			<View style={styles.discountBadgeContainer}>
				...
				>
					...
					<g id="sale_fill" fill="none" fill-rule="evenodd">
			...
			<View style={styles.card}>
				...
				<TouchableOpacity
					...
					accessibilityLabel={
						product.isFavorite ? t('removeFromFavorites') : t('addToFavorites')
					}
				>
					<View>
						<svg
