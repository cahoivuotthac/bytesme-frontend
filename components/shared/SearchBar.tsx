...
export function SearchBar({
	...
	const inputWidthStyle = {
		flex: inputWidthAnim.interpolate({
			inputRange: [0, 1],
			outputRange: [1, 1.2],
		}),
	}

	const buttonsOpacity = inputWidthAnim.interpolate({
		inputRange: [0, 1],
		outputRange: [1, 0],
	})

	const buttonsWidth = inputWidthAnim.interpolate({
		inputRange: [0, 1],
		outputRange: [44, 0],
	})

	const buttonsMargin = inputWidthAnim.interpolate({
		inputRange: [0, 1],
		outputRange: [showFiltersButton ? 12 : 0, 0],
	})
	...
	return (
		<View style={styles.searchContainer}>
			...
			{/* Search input */}
			<Animated.View style={[styles.searchInputWrapper, inputWidthStyle]}>
				<Ionicons
					name="search"
					size={20}
					color="#A48B7B"
			...
			{showAiButton && (
				<Animated.View
					style={{
						opacity: buttonsOpacity,
						width: buttonsWidth,
						marginLeft: inputWidthAnim.interpolate({
							inputRange: [0, 1],
							outputRange: [10, 0],
						}),
					}}
